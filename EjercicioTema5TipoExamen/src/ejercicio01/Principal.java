...
public class Principal {
	...
	public static void main(String[] args) {
		 ...
		 * Estoy dando clases de inglés para el B2 y me gustaría que me ayudarais a crear un diccionario.
			...
			Consideraremos que no se repiten palabras con el mismo nombre, es decir, que la palabra “take”
			no aparece dos veces en el diccionario y que, si tiene varios significados, estos pueden ir en el
			mismo String “significado”, por ejemplo, for---->por, para, durante.
			
			Si quieres, puedes hacer alguno de estos buscar últimos, devolviendo otra lista cuando los
			resultados de una búsqueda pueden ser más de un objeto.
		 */
