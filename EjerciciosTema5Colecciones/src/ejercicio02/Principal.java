...
public class Principal {
	...
	public static void main(String[] args) {
		 ...
		 * Crear un programa para gestionar los socios de un Club de campo. Se debe poder guardar Socios con
			...
			operaciones CRUD" en una clase SociosCrud de la clase Club.
		 */
		...
		listaSocios.add(new Socios ("Manolito", "Pérez Galdiva", "58203657P", true));
		listaSocios.add(new Socios ("Luis Reinaldo", "Núñez Lapiedra", "13122402Q", true));
		listaSocios.add(new Socios ("Ermenegildo", "Pérez Cabrera", "41506774L", false));
		
		
		//Se crea la clase SociosCrud introduciendo la lista de socios
		
		SociosCrud cs = new SociosCrud (listaSocios);
		
		//Se crea la clase Club introduciendo el SociosCrud
		...
		do {
			...
			switch (opc) {
				...
				case 1:
					...
					cs.agregarSocio(new Socios (nombre, apellidos, dni, veterano));
